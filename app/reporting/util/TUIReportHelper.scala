    ...
    val fields = {
      ...
      List(
        ...
        Field(randUUID, "cpcFees",
          Formula("""currency(fees.serving("banner").cpc(clicks))""").some,
          Display(None, currency, summation).some),
        Field(randUUID, "cpmFees",
          Formula("""currency(fees.serving("banner").cpm(impressions))""").some,
          Display(None, currency, summation).some),
        Field(randUUID, "dispFees",
          Formula("""currency(fees.agency("display").monthly(spend, impressions))""").some,
          Display(None, currency, summation).some),
        ...
        Field(randUUID, "totalSpend",
          Formula("currency(spend + cpcFees + cpmFees + dispFees)").some,
          Display("Total Spend".some, currency, summation).some),
        Field(randUUID, "ctr",
          Formula("percentage(clicks / impressions)").some,
          Display(None, percent, average).some),
        Field(randUUID, "cpc",
          Formula("currency(totalSpend / clicks)").some,
        ...
        Field(randUUID, "cpl",
          Formula("currency(totalSpend / totalLeads)").some,
          Display(None, currency, average).some),
        Field(randUUID, "ssc",
          Formula("percentage(totalLeads / clicks)").some,
          Display(None, percent, average).some)
      )
